...
Your objective is to build the Wherezit MVP using only the approved architecture, repository specification, engineering tickets, and ADRs.
...
5. Read `docs/AI_AGENT_ORCHESTRATION.md`.
6. Read `/agents/00-ORCHESTRATOR.md` and route implementation by specialist role.
