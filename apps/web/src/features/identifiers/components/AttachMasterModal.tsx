          ...
          <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
              ...
              >
                ...
                <div>
                  <div style={{ fontWeight: 700, fontSize: '0.95rem', color: '#0f172a' }}>Scan Existing QR / Barcode</div>
                  <div style={{ fontSize: '0.8rem', color: '#64748b' }}>Use a QR code or barcode sticker already on the box.</div>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <div style={{ fontWeight: 700, fontSize: '0.95rem', color: '#0f172a' }}>Add Existing Label</div>
                  <div style={{ fontSize: '0.8rem', color: '#64748b' }}>Record a handwritten, printed, or photographed label already on the box.</div>
                </div>
              </button>
            </div>
          ...
          <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
              ...
              >
                <span style={{ fontSize: '1.75rem' }}>✏️</span>
                <div>
                  <div style={{ fontWeight: 700, fontSize: '0.95rem', color: '#0f172a' }}>Enter Label Text</div>
                  <div style={{ fontSize: '0.8rem', color: '#64748b' }}>Record handwritten or printed text already on the box.</div>
                </div>
              </button>
              ...
              >
                <span style={{ fontSize: '1.75rem' }}>📷</span>
                <div>
                  <div style={{ fontWeight: 700, fontSize: '0.95rem', color: '#0f172a' }}>Take / Choose Label Photo</div>
                  <div style={{ fontSize: '0.8rem', color: '#64748b' }}>Capture or upload a photo of the existing label.</div>
                </div>
              </button>
            </div>
