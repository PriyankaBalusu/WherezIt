...
{
    public partial class AddWorkspaceRenamedAuditEvent : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddCheckConstraint(
                name: "ck_workspace_audits_event_type",
                table: "workspace_audits",
                sql: "event_type IN ('WORKSPACE_CREATED', 'WORKSPACE_RENAMED', 'WORKSPACE_DELETED', 'LOCATION_CREATED', 'LOCATION_RENAMED', 'LOCATION_DELETED')");
        }
