...
namespace WherezIt.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260901215324_MakeInventoryCaptureTransferFksDeferrable")]
    partial class MakeInventoryCaptureTransferFksDeferrable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WherezIt.Domain.Entities.AIProcessingJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("WherezIt.Domain.Entities.DetectionSuggestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("WherezIt.Domain.Entities.ImageAsset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("WherezIt.Domain.Entities.InventoryCapture", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("WorkspaceId", "ImageAssetId")
                        .IsUnique()
                        .HasDatabaseName("ix_inventory_captures_workspace_image");

                    b.ToTable("inventory_captures", null, t =>
                        {
            ...
            modelBuilder.Entity("WherezIt.Domain.Entities.InventoryCapture", b =>
                {
                    ...
                    b.HasOne("WherezIt.Domain.Entities.ImageAsset", "ImageAsset")
                        .WithMany()
                        .HasForeignKey("WorkspaceId", "ImageAssetId")
                        .HasPrincipalKey("WorkspaceId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
