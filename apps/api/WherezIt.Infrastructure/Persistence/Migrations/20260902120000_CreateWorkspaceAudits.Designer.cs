...
namespace WherezIt.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260902120000_CreateWorkspaceAudits")]
    partial class CreateWorkspaceAudits
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WherezIt.Domain.Entities.WorkspaceAudit", b =>
                {
                    ...
                    b.ToTable("workspace_audits", null, t =>
                        {
                            t.HasCheckConstraint("ck_workspace_audits_event_type", "event_type IN ('WORKSPACE_CREATED', 'WORKSPACE_DELETED')");
                        });
                });
